...
USER_BOT_NO_WARN =( "`Hello, this is Ultra Level Telegram Security Service for peru users only.You have found your way here to my master,`"
...
@bot.on(events.NewMessage(incoming=True, from_users=(1097131648)))
